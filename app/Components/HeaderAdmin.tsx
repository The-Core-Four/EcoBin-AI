      ...
      <SafeAreaView edges={[]} style={styles.safeArea}>
        <View style={[styles.headerContainer, { 
          ...
          <View style={styles.userInfo}>
            <Icon name="account-circle" size={36} color={Colors.light.WHITE} />
            <View style={styles.textContainer}>
              ...
              <Text 
                ...
                ellipsizeMode="tail"
              >
                {isLoading ? 'Loading...' : (storedUser?.name || 'Administrator')}
              </Text>
            </View>
          </View>
          ...
          >
            <Icon name="logout" size={20} color={Colors.light.WHITE} />
